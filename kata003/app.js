...
var rateRoutes = require('./routes/rate-routes')(express, authorization, permissions, crypto, models);
var commentRatingApi = require('./api/comment-rating-api')(express, authorization, permissions, models);
